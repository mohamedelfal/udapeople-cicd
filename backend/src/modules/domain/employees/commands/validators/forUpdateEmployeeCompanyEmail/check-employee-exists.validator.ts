...
@Injectable()
export class CheckEmployeeCompanyEmailExists implements ICommandValidator<UpdateEmployeeCompanyEmail> {
  constructor(private readonly employeeRepository: EmployeeRepository) {}

  async validate(command: UpdateEmployeeCompanyEmail): Promise<IValidationResult> {
